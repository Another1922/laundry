<nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <div class="container">
    <a style="font-size: 30px" class="page-scroll oleo-font navbar-brand" href="#home">laura Laundry</a>
...
<section class="pt-5">
  <div class="jumbotron jumbotron-fluid bg-info">
    <div class="container text-white text-center">
      <img style="box-shadow: 5px 5px 5px rgba(0,0,0,0.3)" src="<?= base_url(); ?>assets/img/img_properties/logo.png" alt="logo" class="img-fluid rounded mb-2" width="200" backgraound-color="white">
      <h1 class="text-shadow display-4 oleo-font font-weight-bold">jamblang laundy</h1>
  ...
  <div class="container">
    ...
    <div class="row">
    	<div class="col-lg text-white text-center">
    		<p class="text-white"><span class="oleo-font">laura Laundry</span> adalah aplikasi laundry untuk membantu ibu rumah tangga agar <strong>meringankan</strong> pekerjaan rumahnya. Selain itu, aplikasi ini dapat melihat <strong>timeline</strong> pakaian yang anda laundry menggunakan fitur <strong>cek status pesanan</strong>. Sehingga, anda tidak perlu repot-repot datang ke tempat laundry bila pakaian anda yang sedang dilaundry belum selesai.</p>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-lg-6 my-3">
		    	<h3 class="oleo-font">laura Laundry</h3>
		    	<div class="row">
		    		<div class="col-lg">
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-5"><a class="text-white" target="_blank" href="https://api.whatsapp.com/send?phone=+6285776945166">+62 857 7694 5166</a></div>
        </div>
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-8">Jl. Taman Prima Raya, Pd. Kacang Tim., Kec. Pd. Aren, Kota Tangerang Selatan, Banten 15226</div>
        </div>
      </div>
		</div>
		<div class="row">
