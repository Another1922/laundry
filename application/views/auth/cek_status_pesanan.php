<nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <div class="container">
    <a style="font-size: 30px" class="page-scroll oleo-font navbar-brand" href="<?= base_url('auth/'); ?>#home">laura Laundry</a>
...
<footer class="bg-dark text-white p-4 mt-n5">
	<div class="container-fluid">
		<div class="row justify-content-center">
	    	...
	    	<div class="row">
	    		<div class="col-lg">
					<span>&copy; Copyright <?= date('Y'); ?> All rights Reserved with laura Laundry.</span>
	    		</div>
	    	</div>
			</div>
			<div class="col-lg-6 my-3">
