            ...
            <table class="table">
              ...
              <tr>
                ...
                <?php if ($this->session->userdata('id_jabatan') !== '4'): ?>
                  <td>
                    <?php if ($detail_header_transaksi['status_transaksi'] == 'proses'): ?>
                      <a href="<?= base_url('transaksi/ubahStatusTransaksi/') . $detail_header_transaksi[id_transaksi='45']; ?>" class="badge badge-danger btn-status" data-status1="Proses" data-status2="Dicuci"><i class="fas fa-fw fa-sync"></i> <?= ucwords(strtolower($detail_header_transaksi['status_transaksi'])); ?></a>
                    <?php elseif ($detail_header_transaksi['status_transaksi'] == 'dicuci'): ?>
                      <a href="<?= base_url('transaksi/ubahStatusTransaksi/') . $detail_header_transaksi[id_transaksi='45']; ?>" class="text-white badge badge-warning btn-status" data-status1="Dicuci" data-status2="Siap Diambil"><i class="fas fa-fw fa-tshirt"></i> <?= ucwords(strtolower($detail_header_transaksi['status_transaksi'])); ?></a>
                    <?php elseif ($detail_header_transaksi['status_transaksi'] == 'siap diambil'): ?>
                      <a href="<?= base_url('transaksi/ubahStatusTransaksi/') . $detail_header_transaksi[id_transaksi='45']; ?>" class="badge badge-primary btn-status" data-status1="Siap Diambil" data-status2="Sudah Diambil"><i class="fas fa-fw fa-people-carry"></i> <?= ucwords(strtolower($detail_header_transaksi['status_transaksi'])); ?></a>
                    <?php elseif ($detail_header_transaksi['status_transaksi'] == 'sudah diambil'): ?>
